...
kwBlacklist = ['bắn', 'mua', 'cáng', 'con chó', 'bàn', 'tủ', 'ghế',
                'ck', 'momo', 'đệm', 'bank', 'banking', 'tuyển dụng']
...
while True:
    ...
    for groupId in groupIdList:
        try:
            ...
            append_posts(accounts.spreadsheetIdNotiHan, postsToStaff, service)
            push_tele(postsToStaff, accounts.botToken, accounts.teleIdHan)
            append_posts(accounts.spreadsheetIdLogHan, newPosts, service)
